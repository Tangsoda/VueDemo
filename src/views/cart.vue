	...
	<div>
		...
		<!-- 购物车商品内容 -->
		      ...
		      <div class="item-list-wrap">
		        <div class="cart-item">
		          ...
		          <ul class="cart-item-list">
		            <li v-for="item in itemList" v-bind:key="item.productId">
		        ...
		        <div class="cart-foot-inner">
		          <div class="cart-foot-l">
		            <div class="item-all-check">
		              <a href="javascipt:;" @click="toggleCheck">
		                <span class="checkbox-btn item-check-btn" v-bind:class="{'check':checkFlag}">
		                  <svg class="icon icon-ok">
		 ...
		 <modal :mdShow="modalConfirm" v-on:close="closeModal">
			<template v-slot:message><p slot="message">你确认要删除此条数据吗？</p></template>
